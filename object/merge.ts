...
import type { Anyfy, Depth } from './_internal'
import type { _OptionalKeys } from './optional-keys'
 ...
 * @hidden
 */
type MergeProp<OK, O1K, fill, OOKeys extends Key, K extends Key> = K extends OOKeys // if prop of `O` is optional
  ? Exclude<OK, undefined> | O1K // merge it with prop of `O1`
  : [OK] extends [never]
    ? O1K // complete with prop of `O1`
    : OK extends fill
      ? O1K
      : OK // fill/replace if required
 ...
 * @hidden
 */
export type MergeFlatChoice<O extends object, O1 extends object, ignore extends object, fill> = O extends ignore
  ? O
  : O1 extends ignore
    ? O
    : O extends List
 ...
 * @hidden
 */
type MergeDeepList<L extends List, L1 extends List, ignore extends object, fill> = number extends Length<L | L1>
 ...
 * @hidden
 */
type MergeDeepChoice<OK, O1K, ignore extends object, fill, OOKeys extends Key, K extends Key> = [OK] extends [never]
 ...
 * @hidden
 */
export type MergeDeep<O extends object, O1 extends object, ignore extends object, fill> = O extends unknown
  ? O1 extends unknown
