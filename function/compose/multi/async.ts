...
/** */
import type { Await } from '../../../any/await'
...
export type ComposeMultiAsync = {
  <R0, P extends any[]>(...fns: [Function<P, R0> | Curry<Function<P, R0>>]): Function<P, Promise<Await<R0>>>

  <R0, R1, P extends any[]>(
    ...fns: [Function<[Await<R0>], R1> | Curry<Function<[Await<R0>], R1>>, Function<P, R0> | Curry<Function<P, R0>>]
